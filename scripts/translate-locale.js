...
import { localeNames } from '../packages/i18n/locales';

const directoryPath = path.join(__dirname, '../apps/web/messages');
const { translate } = require('./openai-chat');
const {siteConfig} = require('../apps/web/lib/config/site');
